...
function Project() {
  ...
  const [imageModalProject, setImageModalProject] = useState<ProjectType>(
    _projects[0]
  );
  ...
  return (
    <>
      ...
      >
        ...
        <div
          id="trigger"
          className="cut font-semibold text-white flex flex-col relative overflow-hidden w-[90%] md:w-[80%] "
        >
          <div className="h-full bg-[#1A1E21] w-full p-6 md:p-8 flex justify-center items-center">
            ...
            <div className="hidden md:flex flex-col justify-center items-start gap-3 absolute right-8">
              <span className="flex justify-center items-center gap-3 text-[#ccc] font-normal">
                <i
                  className={`fa-solid ${
                    content
                ...
                ></i>
                {content ? "Expand Details" : "Close Details"}
              </span>
              <span className="flex justify-center items-center gap-3 text-[#ccc] font-normal">
                <i className="fa-solid fa-globe"></i>Live Site
              </span>
              <span className="flex justify-center items-center gap-3 text-[#ccc] font-normal">
                <i className="fa-solid fa-code"></i>Code Repo
              </span>
            </div>
          </div>
          ...
          <div
            className={`${content ? "flex" : "hidden"} ${
              active ? "close" : "open"
            } flex-wrap justify-center items-center gap-4 md:gap-10 w-full p-7 md:p-10 relative`}
          >
            {content &&
              _projects.map((project, index) => (
                ...
                >
                  ...
                  >
                    <span className={`scale-125`}>{project.icon}</span>
                  </div>
                  <div className="flex flex-col justify-start items-start gap-3 w-full p-3 relative">
                    <div className="flex flex-col md:flex-row w-full  gap-5 justify-between items-center">
                      <p
                      ...
                      <div className="flex justify-center items-center gap-5">
                        <i
                          onClick={() => handleDetails(project)}
                          className={`fa-solid fa-up-right-and-down-left-from-center text-[#a2a0a0] cursor-pointer hover:text-[#FFD474]`}
                        ></i>
                        <a
                          href={project.live}
                          target="_blank"
                        ...
                        >
                          <i className="fa-solid fa-globe text-[#a2a0a0] cursor-pointer hover:text-[#FFD474]"></i>
                        </a>
                        <a
                          ...
                          rel="noopener noreferrer"
                        >
                          <i className="fa-solid fa-code text-[#a2a0a0] cursor-pointer hover:text-[#FFD474]"></i>
                        </a>
                      </div>
                    </div>
          ...
          <div
            className={`pt-3 py-5 relative px-6 transition-all ease-linear duration-500 ${
              active ? "close" : "open"
